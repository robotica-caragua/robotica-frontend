...
export function CardEscola({ name, location }) {
  return (
    <div className="flex flex-col bg-white rounded-2xl p-10 w-[28rem] border-b-5 border-1 border-verde-musgo gap-6 justify-center items-center">
