      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="w-[75%] mx-auto py-12 px-8 flex flex-col gap-10">
          ...
          <section className="flex flex-col gap-2 items-center">
            <h2 className="text-verde-escuro text-5xl font-bold leading-tight">Cadastrar Novo Professor</h2>
            <p className="text-verde-musgo text-xl font-normal">Configure as credenciais e acessos do novo docente no sistema.</p>
          </section>
            ...
            <div className="w-full p-8 bg-white rounded-3xl shadow-sm border border-verde-musgo border-opacity-30 flex flex-col gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2 md:col-span-2">
                  <label className="text-verde-musgo text-sm font-bold uppercase tracking-wide px-1">Nome Completo</label>
                  <input type="text" placeholder="Digite o nome completo do professor..." className="w-full px-4 py-3.5 bg-input-bg border border-verde-musgo rounded-xl text-verde-escuro placeholder-verde-escuro placeholder-opacity-50 focus:outline-none transition" />
                </div>

                <div className="flex flex-col gap-2">
                  <label className="text-verde-musgo text-sm font-bold uppercase tracking-wide px-1">Matrícula</label>
                  <input type="text" placeholder="Digite a matrícula..." className="w-full px-4 py-3.5 bg-input-bg border border-verde-musgo rounded-xl text-verde-escuro placeholder-verde-escuro placeholder-opacity-50 focus:outline-none transition" />
                </div>

                <div className="flex flex-col gap-2">
                  <label className="text-verde-musgo text-sm font-bold uppercase tracking-wide px-1">E-mail</label>
                  <input 
                    type="email" 
                    value={email}
                ...
                <div className="flex flex-col gap-2 md:col-span-2">
                  <label className="text-verde-musgo text-sm font-bold uppercase tracking-wide px-1">Escola Vinculada</label>
                  <select defaultValue="" className="w-full px-4 py-3.5 bg-input-bg border border-verde-musgo rounded-xl text-verde-escuro focus:outline-none appearance-none cursor-pointer">
                    <option value="" disabled>Selecione a unidade onde o professor lecionará as oficinas...</option>
