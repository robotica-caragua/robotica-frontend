...
export default function HeroSection() {
  return (
    ...
    <section className="relative flex items-center justify-between px-20 py-24 overflow-hidden">
      <div className="max-w-2xl z-10">
        ...
        <p className="mt-8 text-2xl max-w">
          Conectando escolas, estudantes e a comunidade 
          de Caraguatatuba através da tecnologia.
        </p>

        <button className="mt-10 flex items-center gap-4 px-8 py-4 rounded-xl border border-[#506600] text-[#506600] font-bold hover:bg-[#506600] hover:text-white transition">
          Explorar Projetos
